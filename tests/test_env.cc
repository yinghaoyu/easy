...
int main(int argc, char** argv)
{
    ...
    std::cout << "path=" << easy::EnvMgr::GetInstance()->env("PATH", "xxx") << std::endl;
    std::cout << "test=" << easy::EnvMgr::GetInstance()->env("TEST", "") << std::endl;
    std::cout << "set env " << easy::EnvMgr::GetInstance()->setEnv("TEST", "test") << std::endl;
    std::cout << "test=" << easy::EnvMgr::GetInstance()->env("TEST", "") << std::endl;

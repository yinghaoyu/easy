...
easy::ConfigVar<float>::ptr g_int_valuex_config = easy::Config::Lookup(
...
easy::ConfigVar<std::vector<int>>::ptr g_int_vec_value_config =
    easy::Config::Lookup("system.int_vec", std::vector<int>{1, 2},
                         "system int vec");

easy::ConfigVar<std::list<int>>::ptr g_int_list_value_config =
    easy::Config::Lookup("system.int_list", std::list<int>{1, 2},
                         "system int list");

easy::ConfigVar<std::set<int>>::ptr g_int_set_value_config =
    easy::Config::Lookup("system.int_set", std::set<int>{1, 2},
                         "system int set");

easy::ConfigVar<std::unordered_set<int>>::ptr g_int_uset_value_config =
    easy::Config::Lookup("system.int_uset", std::unordered_set<int>{1, 2},
                         "system int uset");
...
easy::ConfigVar<std::unordered_map<std::string, int>>::ptr
    g_str_int_umap_value_config = easy::Config::Lookup(
...
int main(int argc, char** argv) {
  ...
  easy::Config::Visit([](easy::ConfigVarBase::ptr var) {
    EASY_LOG_INFO(EASY_LOG_ROOT())
        ...
        << " typename=" << var->typeName() << " value=" << var->toString();
  });

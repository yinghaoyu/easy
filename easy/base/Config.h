...
class ConfigVar : public ConfigVarBase
{
  public:
    ...
    std::string toString() override
    {
        ...
        {
            ELOG_ERROR(ELOG_ROOT()) << "ConfigVar::toString exception " << e.what() << " convert: " << TypeToName<T>() << " to string"
                                    << " name=" << name_;
        }
        return "";
    }
...

    {
        ...
        {
            ELOG_ERROR(ELOG_ROOT()) << "ConfigVar::fromString exception" << e.what() << " convert: string to " << TypeToName<T>() << " name=" << name_
                                    << " - " << val;
        }
        return false;
    }
  ...
  public:
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string& name, const T& default_value, const std::string& description = "")
    {
        ...
        if (it != GetDatas().end())
        {
            ...
            {
                ELOG_ERROR(ELOG_ROOT()) << "Lookup name=" << name << " exists but type not " << TypeToName<T>()
                                        << " real_type=" << it->second->typeName() << " " << it->second->toString();
                return nullptr;
            }
        }

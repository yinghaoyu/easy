...
static ssize_t do_io(int fd, OriginFunC func, const char* hook_fun_name,
...
unsigned int sleep(unsigned int seconds) {
  ...
  easy::IOManager* iom = easy::IOManager::GetThis();
  iom->addTimer(seconds * 1000, std::bind(static_cast<void (easy::Scheduler::*)(
                                              easy::Fiber::ptr, int threadId)>(
...
int usleep(useconds_t usec) {
  ...
  easy::Fiber::ptr co = easy::Fiber::GetThis();
  easy::IOManager* iom = easy::IOManager::GetThis();
  iom->addTimer(usec / 1000, std::bind(static_cast<void (easy::Scheduler::*)(
                                           easy::Fiber::ptr, int threadId)>(
                                           &easy::IOManager::schedule),
                                       iom, co, -1));
  easy::Fiber::YieldToHold();
...
int nanosleep(const struct timespec* req, struct timespec* rem) {
  ...
  easy::Fiber::ptr co = easy::Fiber::GetThis();
  easy::IOManager* iom = easy::IOManager::GetThis();
  iom->addTimer(timeout_ms, std::bind(static_cast<void (easy::Scheduler::*)(
                                          easy::Fiber::ptr, int threadId)>(
                                          &easy::IOManager::schedule),
                                      iom, co, -1));
  easy::Fiber::YieldToHold();
...
ssize_t recvfrom(int sockfd, void* buf, size_t len, int flags,
  ...
  return do_io(sockfd, recvfrom_f, "recvfrom", easy::Channel::READ, SO_RCVTIMEO,
...
ssize_t sendmsg(int s, const struct msghdr* msg, int flags) {
  return do_io(s, sendmsg_f, "sendmsg", easy::Channel::WRITE, SO_SNDTIMEO, msg,
               flags);
}

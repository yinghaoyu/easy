...
void FileUtil::ListAllFile(std::vector<std::string>& files,
...
bool FileUtil::IsRunningPidfile(const std::string& pidfile) {
...
bool FileUtil::Realpath(const std::string& path, std::string& rpath) {
...
bool FileUtil::Symlink(const std::string& from, const std::string& to) {
  if (!Rm(to)) {
    return false;
  }
...
bool FileUtil::OpenForRead(std::ifstream& ifs, const std::string& filename,
                           std::ios_base::openmode mode) {
  ifs.open(filename.c_str(), mode);
  return ifs.is_open();
}

bool FileUtil::OpenForWrite(std::ofstream& ofs, const std::string& filename,
                            std::ios_base::openmode mode) {
